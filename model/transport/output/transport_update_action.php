...
if($trans_id == "")
            {
                header("location:transport_insert_form.php?action=edit&return=0");
                exit;
            }
if($trans_name == "")
            {
                header("location:transport_insert_form.php?action=edit&return=1");
                exit;
            }
if($trans_price == "")
            {
                header("location:transport_insert_form.php?action=edit&return=2");
                exit;
            }
...
<html>
    ...
    <body>
        ...
        <br/>
        <a href="transport_insert_form.php">กลับหน้าinsert new transport</a> 
    </body>
</html>
