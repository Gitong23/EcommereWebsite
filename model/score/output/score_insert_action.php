...
if($score_id == "")
            {
                header("location:score_insert_form.php?return=0");
                exit;
            }
if($user_id == "")
            {
                header("location:score_insert_form.php?return=1");
                exit;
            }
if($product_id == "")
            {
                header("location:score_insert_form.php?return=2");
                exit;
            }
...
<html>
    ...
    <body>
        ...
        <br/>
        <a href="score_insert_form.php">กลับหน้าinsert new customer</a> 
    </body>
</html>
