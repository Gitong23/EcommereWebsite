...
if($order_detail_id == "")
            {
                header("location:order_detail_insert_form.php?return=0");
                exit;
            }
if($order_id == "")
            {
                header("location:order_detail_insert_form.php?return=1");
                exit;
            }
if($product_attr_id == "")
            {
                header("location:order_detail_insert_form.php?return=2");
                exit;
            }
if($qty == "")
            {
                header("location:order_detail_insert_form.php?return=3");
                exit;
            }
   ...
   $isSuccess = insertNeworder_detail(               
...
<html>
    ...
    <body>
        ...
        <br/>
        <a href="order_detail_insert_form.php">กลับหน้าinsert new customer</a> 
    </body>
</html>
