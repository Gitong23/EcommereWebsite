...
if($product_attr_id == "")
            {
                header("location:product_attr_insert_form.php?action=edit&return=0");
                exit;
            }
if($product_id == "")
            {
                header("location:product_attr_insert_form.php?action=edit&return=1");
                exit;
            }
if($attr_name == "")
            {
                header("location:product_attr_insert_form.php?action=edit&return=2");
                exit;
            }
if($product_stock == "")
            {
                header("location:product_attr_insert_form.php?action=edit&return=3");
                exit;
            }
if($sale == "")
            {
                header("location:product_attr_insert_form.php?action=edit&return=4");
                exit;
            }
...
<html>
    ...
    <body>
        ...
        <br/>
        <a href="product_attr_insert_form.php">กลับหน้าinsert new product_attr</a> 
    </body>
</html>
