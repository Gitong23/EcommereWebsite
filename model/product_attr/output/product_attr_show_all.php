...
<html>
    <head>
        ...
        <script>
            ...
            function loadTable()
            {
                 $("#table").load("product_attr_show_all_table.php",function(responseTxt,statusTxt,xhr)
		    {
                    });
            }
            function confirm_delete(id)
            {
                ...
                if (r == true)
                {
                    ...
                    //ajax
                    $("#data").load("product_attr_delete.php?id="+id,function(responseTxt,statusTxt,xhr)
		    {
                        console.log("b");
